...
mkdir ~/.vnc
openssl req -x509 -newkey rsa:4096 -keyout ~/.vnc/vncserver.key -out ~/.vnc/vncserver.crt -days 365 -nodes -subj "/C=virtual　Japan/ST=vurtual Tokyo/L=vurtual Syibuya/O=Liniuxchan and follows/OU=リナックスで遊ぶ
