...
mkdir ~/.vnc
openssl req -x509 -newkey rsa:4096 -keyout ~/.vnc/vncserver.key -out ~/.vnc/vncserver.crt -days 365 -nodes -subj "/C=virtual日本/ST=vurtual東京/L=vurtual渋谷/O=Liniuxchanと仲間たち/OU=リナックスで遊ぶ部門/CN=リニアクスちゃんonあなたのスマホ"
